...
{
    protected override string SpritePath => "PUMP/Sprite/ingame/LogicSymbols/NAND";
    ...
    protected override float InEnumeratorXPos => -35f;

    protected override float OutEnumeratorXPos => 43f;
