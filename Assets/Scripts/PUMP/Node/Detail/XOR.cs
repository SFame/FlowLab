...
{
    protected override string SpritePath => "PUMP/Sprite/ingame/LogicSymbols/XOR";
    ...
    protected override Vector2 NameTextOffset => new Vector2(8f, -3f);
    ...
    protected override float InEnumeratorXPos => -14f;
