...
public class Atan2 : Node
{
    ...
    protected override string NodeDisplayName => "Atan2";

    protected override List<string> InputNames => new() { "in1", "in2" };

    protected override List<string> OutputNames => new() { "out" };

    protected override List<TransitionType> InputTypes => new() { TransitionType.Float, TransitionType.Float };
    ...
    private Transition Operate()
    {
        ...
        Transition result = Mathf.Atan2(InputToken.FirstState.Convert(TransitionType.Float), InputToken.LastState.Convert(TransitionType.Float));
        return result;
    }
