...
public class Any : DynamicIONode, INodeAdditionalArgs<int>
{
    ...
    protected override string NodeDisplayName => "Any";
    ...
    {
        OutputToken.PushFirst(AnyOperate());
    }

    private Transition AnyOperate()
    {
        ...
        return InputToken.Any(sf => sf.State);
    }
